...
Canonical `ONLYOFFICE_*` variables win over aliases. For example.com operator
...
| `OO_URL`, `OO_USER`, `OO_PASS` | CLI-only example.com aliases mapped to `ONLYOFFICE_URL`, `ONLYOFFICE_USER`, `ONLYOFFICE_PASS` |
