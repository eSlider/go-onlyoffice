...
Operational rules learned from real billing work (Medex P-2026-02, Edelweiss P-2026-01).
...
- Hub title: `CC | Company` (e.g. `DE | Medex Ambulanter Pflegedienst GmbH`).
...
oo invoices create --number P-YYYY-NN --contact 1328 --item N \
  --price 300 --opportunity 1031 --language de-DE …
